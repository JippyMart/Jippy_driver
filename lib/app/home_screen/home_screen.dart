                  ...
                  Expanded(
                    child: RoundedButtonFill(
                      ...
                      onPress: () async {
                        ...
                        if (controller.currentOrder.value.id != null) {
                          final updatedOrder = await FireStoreUtils.getOrderById(controller.currentOrder.value.id!);
                            ...
                            InkWell(
                              onTap: () async {
                                ...
                                if (customer != null && customer.phoneNumber != null) {
                                  Constant.makePhoneCall(customer.phoneNumber!);
                                } else {
                                  ShowToastDialog.showToast("Customer phone number not available");
                                }
                              },
                              child: Container(
                                width: 42,
                ...
                controller.currentOrder.value.paymentMethod?.toLowerCase() ==
                  ...
                  children: [
                    ...
                    FutureBuilder<double?>(
                      future: fetchToPayForOrder(controller.currentOrder.value.id!),
